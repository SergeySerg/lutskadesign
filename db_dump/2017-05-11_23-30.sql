...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 11 2017 г., 23:24
...
(1, 0, 0, 'main', 'Главная@|;Main@|;', '', '@|;@|;', '@|;@|;', '[]', '{"base":["title","short_description"],"attributes":{}}', '0000-00-00 00:00:00', 1, 'Дизайнер интерьеров Яна Луцкая@|;@|;', '@|;@|;', '@|;@|;', 0, '2017-04-27 20:45:45', '2017-05-11 20:08:56'),
